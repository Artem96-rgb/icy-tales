...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-4.5 whitespace-nowrap rounded-full text-base/4 font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive cursor-pointer border [&_svg]:size-4 [&_svg]:stroke-3 [&_svg]:transition-all",
  {
    variants: {
      variant: {
        default:
